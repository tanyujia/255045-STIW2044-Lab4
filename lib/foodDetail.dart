...
class _DetailInterfaceState extends State<DetailInterface> {
  ...
  void _onAcceptFood() {
     if (widget.user.email=="user@noregister"){
      Toast.show("Please register to view accept food", context,
  ...
  Future<String> acceptRequest() async {
    String urlLoadFood = "http://mobilehost2019.com/MyFoodNeverWaste/php/accept_food.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
    pr.style(message: "Accepting Food");
    pr.show();
    http.post(urlLoadFood, body: {
      "jobid": widget.food.foodid,
