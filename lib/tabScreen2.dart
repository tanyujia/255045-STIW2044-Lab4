...
class _TabScreen2State extends State<TabScreen2> {
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onLongPress: () => _onJobDelete(
                              data[index]['foodid'].toString(),
                              data[index]['foodtitle'].toString()),
                          child: Padding(
  ...
  Future init() async {
    if (widget.user.email == "user@noregister") {
      Toast.show("Please register to view posted food", context,
  ...
  void _onJobDelete(String foodid, String foodname) {
    print("Delete " + foodid);
    _showDialog(foodid, foodname);
  }

  void _showDialog(String foodid, String foodname) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Delete " + foodname),
  ...
  Future<String> deleteRequest(String foodid) async {
    String urlLoadFood =
        "http://mobilehost2019.com/MyFoodNeverWaste/php/delete_food.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
